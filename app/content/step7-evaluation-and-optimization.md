...
In the introduction we discussed the importance of taking a holistic approach to product design and using Design Principles to guide holistic design. Product design as a creative endeavor requires tradeoffs. While tradeoffs are inevitable and challenging, there are different ways to manage them.
...
![](../assets/7-evaluation-and-optimization/principles-of-sustainable-design.png)
