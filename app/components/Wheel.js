...
export default function Wheel({onWheelClick, ...otherProps}) {
  return (
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(1)}} transform="translate(111.61 33.94)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>DESIGN <tspan x={0} y="14.4">G</tspan>
    <tspan x="9.28" y="14.4" style={{letterSpacing: '-0.01806640625em'}}>O</tspan>
    <tspan x="19.25" y="14.4">ALS</tspan>
    </text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(2)}} transform="translate(226.07 48.73)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>FEED<tspan x="30.68" y={0} style={{letterSpacing: '-0.015950520833333332em'}}>S</tspan>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(3)}} transform="translate(285.82 149.27)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>PRODU<tspan x="42.79" y={0} style={{letterSpacing: '-0.006022135416666667em'}}>C</tspan>
    <tspan x="51.07" y={0}>TION</tspan>
    </text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(4)}} transform="translate(274.87 263.91)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>USE</text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(5)}} transform="translate(141.27 322.72)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>END OF LIFE</text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(6)}} transform="translate(27.16 238.43)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>WHOLE <tspan x={0} y="14.4">PRODU</tspan>
    ...
    <text  className={styles.wheelSection} onClick={() => {onWheelClick(7)}} transform="translate(16 125.27)" style={{fontSize: 12, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>E<tspan x="7.32" y={0} style={{letterSpacing: '-0.029947916666666668em'}}>V</tspan>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(1)}} transform="translate(91.61 61.51)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(2)}} transform="translate(218 63.51)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>Decouple feedstock<tspan x={0} y={12}>f</tspan>
    <tspan x="3.24" y={12} style={{letterSpacing: '-0.01796875em'}}>r</tspan>
    <tspan x="6.7" y={12}>om multiple impacts</tspan>
    </text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(3)}} transform="translate(288.26 168.9)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>Identify chemicals <tspan x={0} y={12} xmlSpace="preserve">  used/p</tspan>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(4)}} transform="translate(256.54 279.15)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(5)}} transform="translate(142.73 341.59)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>Design for<tspan x={0} y={12}>ci</tspan>
    <tspan x="7.56" y={12} style={{letterSpacing: '-0.01796875em'}}>r</tspan>
    <tspan x="11.02" y={12}>cularity</tspan>
    </text>
    <text className={styles.wheelSection} onClick={() => {onWheelClick(6)}} transform="translate(29.16 265.86)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>
    <tspan style={{letterSpacing: '-0.01201171875em'}}>C</tspan>
    ...
    <text className={styles.wheelSection} onClick={() => {onWheelClick(7)}} transform="translate(15.68 154.82)" style={{fontSize: 10, fill: '#fff', fontFamily: 'AvenirNext-DemiBold, Avenir Next', fontWeight: 700}}>Design and <tspan x={0} y={12}>innov</tspan>
